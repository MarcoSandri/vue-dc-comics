    ...
    <section class="content">
        <div class="container">
          <span class="label title">CURRENT SERIES</span>
            <div class="comics">
              <ComicCard v-for="(comic, index) in comics" :key="index" :name="comic.series" :url="comic.thumb"/>
            </div>
...
<script>
import JumboComponent from './partials/JumboComponent.vue'
import ComicCard from './partials/ComicCard.vue'
